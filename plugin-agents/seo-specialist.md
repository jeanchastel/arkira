---
name: seo-specialist
description: Delegated, isolated-context SEO audit agent. Invoke it to run a technical SEO, on-page, structured-data, Core Web Vitals, or sitemap/robots audit and return a findings report. For SEO workflow and how-to guidance, use the seo skill instead.
