...
emit_failure() {
  ...
  printf '{"timestamp":"%s","wrapper_version":"0.134.19","project_ref":null,"target":null,"action":"reset-password","password_mode":null,"status":"%s","exit_code":%s,"request_id":null}\n' \
