---
name: seo
description: "Canonical SEO workflow and how-to: plan and implement technical SEO, on-page optimization, structured data, Core Web Vitals, and sitemap/robots work. Use for hands-on SEO guidance; for a delegated, isolated-context audit that returns a findings report, use the seo-specialist agent."
origin: ECC
---
...
This is a workflow, not a file scanner; when it reads files under deploy-prep, use the shared working set and do not re-enumerate.
